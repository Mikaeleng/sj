...
<html class="no-js" lang="">
    <head>
        ...
        <link rel="stylesheet" href="css/sidr/slicknav.css">
        <link rel="stylesheet" href="css/sidr/jquery.sidr.dark.css">
        <link rel="stylesheet" href="css/sidr/style_fold_even.css">
...
?>
    ...
    <div class="pure-g" id="header">
        ...
        <div class="pure-u-1 pure-u-sm-1-5" id="headline"><span>SJ idag</span></div>
    ...
    <!-- edit panel state 2 -->
       ...
       <!-- <script>window.jQuery || document.write('<script src="js/vendor/jquery-{{JQUERY_VERSION}}.min.js"><\/script>')</script> -->
        ...
        <script src="js/main.js"></script>
            ...
            <script src="js/vendor/sidr/jquery-ui.min.js"></script>
            ...
            <script src="js/vendor/sidr/jquery.slicknav.js"></script>
    </body>
</html>
